...
import { CustomAppHeading, customAppIndustry, CustomAppServiceHeading, customAppServices, CustomAppServices, CustomAppServiceSectionData, customAppSolutions, customAppTech, softwareCategories, WhatMakesCustomApp } from '@/data/custom-app';
...
export default function Page() {
    ...
    return (
        <>
            ...
            <BlueTagBanner sectionHeading={customAppTech} />
