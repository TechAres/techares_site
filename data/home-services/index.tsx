import { Service } from "@/src/sections/services";
        ...
        details: [
            {
                ...
                description: 'Build robust software systems that automate workflows, improve efficiency, and support the needs of large organizations, ensuring seamless integration with existing processes and tools.'
            },
            {
                title: 'Web and Mobile Applications',
                description: 'Develop responsive, user-friendly web and mobile apps that offer exceptional performance and intuitive experiences, tailored to meet user needs and market demands.'
            },
            {
                title: 'API Development and Integration',
                description: 'Design and integrate APIs to connect systems, enhance data flow, and enable seamless interaction between different platforms and services.'
            },
            {
                title: 'Cloud-Based Applications',
                description: 'Create scalable cloud-native applications that ensure accessibility, reliability, and flexibility while reducing infrastructure costs.'
            },
            {
                title: 'Legacy System Modernization',
                description: 'Upgrade outdated systems to improve performance, security, and compatibility with modern technologies, ensuring a smooth transition without business disruption.'
            }
        ]
    },
    {
        ...
        details: [
            {
                ...
                description: "Collaborate with our experts to identify technological gaps and opportunities, creating a clear strategy that aligns IT capabilities with your business objectives."
            },
            {
                title: "Cloud Migration Services",
                description: "Transition your systems and data to secure cloud environments with minimal downtime, ensuring enhanced collaboration, scalability, and cost-efficiency."
            },
            {
                title: "Cybersecurity Solutions",
                description: " Protect your digital assets with customized security frameworks, including threat detection, data encryption, and regular vulnerability assessments."
            },
            {
                title: "Infrastructure Optimization",
                description: "Assess and enhance your IT infrastructure for maximum efficiency, reliability, and cost savings while ensuring scalability for future needs."
            },
            {
                title: "Custom IT Solutions",
                description: "Develop innovative IT solutions to address specific business challenges, ensuring seamless integration with existing systems and workflows."
            }
        ]
    },
    {
        ...
        details: [
            {
                ...
                description: "Improve search engine rankings by optimizing your website's structure, content, and keywords, ensuring better visibility and organic traffic growth."
            },
            {
                title: "Social Media Management",
                description: "Develop and execute creative campaigns across platforms like Instagram, LinkedIn, and Facebook to engage audiences and build brand loyalty."
            },
            {
                title: "Content Marketing",
                description: "Craft compelling blogs, videos, and infographics that educate, entertain, and convert your audience into loyal customers."
            },
            {
        ...
        details: [
            {
                ...
                description: "Design and implement user interfaces with a focus on responsiveness, aesthetics, and functionality to deliver immersive user experiences."
            },
            {
    ...
    },
    {
        ...
        details: [
            ...
            },
            {
                ...
                description: "Build decentralized applications that operate on secure, peer-to-peer networks, offering greater transparency and user autonomy."
            },
            {
